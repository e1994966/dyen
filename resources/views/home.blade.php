...
<!-- HERO SECTION -->
<section class="bg-dyenBg dark:bg-gray-900 pt-6 sm:pt-28 sm:pb-28 overflow-hidden">
  <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
    <div>
      <h1 class="text-3xl sm:text-5xl font-bold text-dyenText dark:text-white mb-6 leading-tight">
        彈性空間，專業形象，<br class="hidden sm:block">讓你專注做最重要的事
      </h1>
      <p class="text-dyenText/80 dark:text-gray-300 mb-6">
        岱恩商務中心提供從共享辦公到活動場地與公司登記的一站式解決方案，無論你是剛起步的創業者，還是尋求專業門面的成長型團隊，這裡都是理想據點。
      </p>
      <a href="/about-us" class="bg-dyen hover:bg-dyenSoft text-white font-semibold px-6 py-2.5 rounded-full transition inline-block hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-dyenSoft w-full sm:w-auto text-center" data-aos="fade-up">
        關於岱恩
      </a>
    </div>
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
      <img src="/images/mockpic11.jpg" data-aos="fade-right" class="rounded-lg shadow-lg w-full max-w-full h-auto object-cover" alt="Team Collaboration">
      <div class="hidden md:grid md:grid-rows-2 gap-4">
        <img src="/images/mockpic02.jpg" data-aos="fade-down" class="rounded-lg shadow-lg w-full max-w-full h-auto object-cover" alt="Plant and Laptop">
        <img src="/images/mockpic03.jpg" data-aos="fade-up" class="rounded-lg shadow-lg w-full max-w-full h-auto object-cover" alt="Team Planning">
      </div>
    </div>
  </div>
</section>
...
<!-- SERVICE SECTION -->
<section class="bg-dyenBg dark:bg-gray-900 py-20 sm:py-28 overflow-hidden">
...
<!-- FLOW SECTION -->
<section class="bg-dyenBg dark:bg-gray-800 py-20 overflow-hidden">
  <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-6">
...
<section class="bg-dyenBg dark:bg-gray-900 py-20 sm:py-28 overflow-hidden">
  <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-6 text-center">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12">
      ...
      <div class="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl shadow-lg" data-aos="flip-up">
...
<section class="bg-dyenBg dark:bg-gray-900 py-20 sm:py-28 overflow-hidden">
  <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-6">
    <div class="text-center mb-12">
      <p class="text-dyen font-semibold uppercase text-sm mb-2">常見問題</p>
      <h2 class="text-3xl sm:text-4xl font-bold text-dyenText dark:text-white">你可能想問的事</h2>
    </div>
    <div class="space-y-6 max-w-3xl mx-auto">
      <div>
        <h3 class="text-lg font-semibold text-dyenText dark:text-white">Q：我可以租幾天？有最短租期嗎？</h3>
        <p class="text-dyenText/80 dark:text-gray-300">我們提供日租、週租、月租等多種方案，依需求彈性安排，無最低租期限制。</p>
      </div>
      <div>
        <h3 class="text-lg font-semibold text-dyenText dark:text-white">Q：會議室可以單獨租嗎？</h3>
        <p class="text-dyenText/80 dark:text-gray-300">可以，依需求提前預定時段即可使用。</p>
      </div>
      <div>
        <h3 class="text-lg font-semibold text-dyenText dark:text-white">Q：公司地址登記合法嗎？</h3>
        <p class="text-dyenText/80 dark:text-gray-300">我們提供合法地址與登記文件，可作為公司或工作室的登記地址。</p>
      </div>
    </div>
    <div class="text-center mt-10">
      <a href="/FAQ" class="bg-dyen hover:bg-dyenSoft text-white font-semibold px-6 py-2.5 rounded-full transition inline-block hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-dyenSoft" data-aos="fade-up">
        查看完整 FAQ
      </a>
    </div>
  </div>
...
<!-- CTA SECTION -->
<section class="bg-[#e7bfbf] py-20 sm:py-28 overflow-hidden">
  <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-6 text-center">
    <h2 class="text-3xl sm:text-4xl font-bold text-dyen dark:text-white mb-4">準備好開始了嗎？</h2>
    <p class="text-dyenText/80 max-w-xl mx-auto text-lg font-semibold mb-6">
      不論你正處於創業起步、團隊擴張或建立專業形象的階段<br>岱恩都能成為你最穩定的後盾。
    </p>
    <a href="/contact" class="bg-dyen hover:bg-dyenSoft text-white font-semibold px-6 py-2.5 rounded-full transition inline-block hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-dyenSoft w-full sm:w-auto">
      立即預約參觀
    </a>
  </div>
</section>
